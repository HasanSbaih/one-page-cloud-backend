...
export interface ResourcesLinksList {
    ...
    //a list of the most three potential operations description that could be performed between {source} and {destination}, each operation should be euniqe for the user to select from.
